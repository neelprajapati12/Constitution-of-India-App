...
class AmendmentsPage extends StatefulWidget {
  final description;
  final title;
  const AmendmentsPage({this.title, this.description, super.key});

  @override
  State<AmendmentsPage> createState() => _AmendmentsPageState();
}

class _AmendmentsPageState extends State<AmendmentsPage> {
  double fontSize = 18;
